...
The following is a breakdown of the major groups of functions - note
that not all are included.
...
If your CouchDB instance requires username and password make sure to
pass those to `Cushion$new`
...
Note how we used a document id in the first document creation, but not
in the second and third. Using a document id is optional.
